...
class EitEnvironment:
    ...
    def plot_inj_stage(self):
        assert hasattr(self, 'el_plus'), print("Please use '.set_inj_stage()' to create the injection stage.")
        ...
        legend_elements.append(patches.Patch(edgecolor="C0", facecolor="none", label="Domain"))
